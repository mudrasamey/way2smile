...
var b = (e, t, r) => (r = e != null ? Is(As(e)) : {}, kr(
  ...
  e
)), Gs = (e) => kr(Z({}, "__esModule", { value: !0 }), e);
...
var yt = p((ql, ht) => {
  ...
  ht.exports = Qr;
  ht.exports.default = Qr;
});

// ../node_modules/cross-spawn/lib/util/resolveCommand.js
var rn = p((Hl, tn) => {
  "use strict";
  var Zr = require("path"), Ws = Yr(), Hs = yt();
  function en(e, t) {
    ...
    try {
      a = Ws.sync(e.command, {
        path: r[Hs({ env: r })],
        pathExt: t ? Zr.delimiter : void 0
      });
    } catch {
    } finally {
      s && process.chdir(n);
    }
    return a && (a = Zr.resolve(i ? e.options.cwd : "", a)), a;
  }
...
var mn = p((Zl, dn) => {
  "use strict";
  var Qs = require("path"), fn = rn(), pn = nn(), Zs = ln(), ea = process.platform === "win32", ta = /\.(?:com|exe)$/i, ra = /node_modules[\\/].bin[\\/][^\\/]+\.cmd$/i;
  function na(e) {
    e.file = fn(e);
  ...
  function oa(e) {
    ...
    if (e.options.forceShell || r) {
      let n = ra.test(t);
      e.command = Qs.normalize(e.command), e.command = pn.command(e.command), e.args = e.args.map((s) => pn.argument(s, n));
...
var ro = p((Bf, to) => {
  "use strict";
  var eo = Jn(), Zn = Yn(), Ya = Rt(), Qa = /* @__PURE__ */ o((e, t) => {
    t === void 0 || e.stdin === void 0 || (eo(t) ? t.pipe(e.stdin) : e.stdin.end(t));
  }, "handleInput"), Za = /* @__PURE__ */ o((e, { all: t }) => {
    ...
    if (!(!e || !r))
      return t ? Zn(e, { encoding: t, maxBuffer: n }) : Zn.buffer(e, { maxBuffer: n });
...
var Ao = /* @__PURE__ */ o(() => {
  let e = Ft - Ro + 1;
  return Array.from({ length: e }, Qc);
}, "getRealtimeSignals"), Qc = /* @__PURE__ */ o((e, t) => ({
  name: `SIGRT${t + 1}`,
  number: Ro + t,
  action: "terminate",
  description: "Application-specific signal (realtime)",
...
}, "noop"), Qt = /* @__PURE__ */ o(({ contents: e }) => e, "getContentsProp"), He = /* @__PURE__ */ o((e) => {
...
tEncoder"), wu = new TextEncoder(), Yo = /* @__PURE__ */ o((e) => new Uint8Array(e), "useUint8Array"), Qo = /* @__PURE__ */ o((e) => new Uint8Array(
...
Pu = /* @__PURE__ */ o((e, { contents: t, length: r }, n) => {
  ...
  return new Uint8Array(r).set(new Uint8Array(e), 0), r;
}, "resizeArrayBuffer"), ei = /* @__PURE__ */ o((e) => Zo ** Math.ceil(Math.log(e) / Math.log(Zo)), "getNewContentsLength"), Zo = 2, ku = /* @__PURE__ */ o(
...
var Gi = b(require("node:process"), 1), ji = b(require("node:path"), 1), Ze = b(require("node:fs"), 1), Ni = require("node:url");
var Bi = {
...
function fr(e, {
  ...
  Ju(r), t = Xu(t);
  let i = n ? Ze.default.statSync : Ze.default.lstatSync;
  for (let s of e)
    try {
...
// ../node_modules/pkg-dir/node_modules/find-up/index.js
var Yu = /* @__PURE__ */ o((e) => e instanceof URL ? (0, Mi.fileURLToPath)(e) : e, "toPath"), Qu = Symbol("findUpStop");
function Zu(e, t = {}) {
  ...
  for (; ; ) {
    let l = c({ ...t, cwd: r });
    if (l === Qu || (l && u.push(pe.default.resolve(r, l)), r === i || u.length >= s))
      break;
...
var Yi = require("node:fs/promises"), Qi = require("node:path");
var hr = /* @__PURE__ */ o(async (e) => {
  ...
  let t = require.resolve((0, Qi.join)(e, "package.json"), {
    paths: [process.cwd()]
  });
...
async function rs(e) {
  ...
  if (!r)
    return {};
  let n = Zi(r, sl), i = Zi(r, il), s = al(t), a = typeof e.framework == "object" ? e.framework.options : {};
  return {
    framework: {
      name: s,
      options: a
...
// ../node_modules/nanoid/index.js
var fl = 128, M, Q, pl = /* @__PURE__ */ o((e) => {
  !M || M.length < e ? (M = Buffer.allocUnsafe(e * fl), (0, Sr.randomFillSync)(M), Q = 0) : Q + e > M.length && ((0, Sr.randomFillSync)(M), Q =
  0), Q += e;
}, "fillPool");
