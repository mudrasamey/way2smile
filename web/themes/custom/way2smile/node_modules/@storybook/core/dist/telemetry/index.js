...
var o = (e, t) => Qe(e, "name", { value: t, configurable: !0 }), y = /* @__PURE__ */ ((e) => typeof require < "u" ? require : typeof Proxy <
"u" ? new Proxy(e, {
...
var Vi = (e, t, r, n) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let i of qi(t))
      !Hi.call(e, i) && i !== r && Qe(e, i, { get: () => t[i], enumerable: !(n = $i(t, i)) || n.enumerable });
  return e;
};
...
var lt = p((mf, L) => {
  "use strict";
  var nn = y("child_process"), ct = Zr(), ut = rn();
  function on(e, t, r) {
...
var _n = p((Df, Rn) => {
  ...
  forceKillAfterTimeout: e = !0 }) => {
    ...
    return e;
  }, "getForceKillAfterTimeout"), Qs = /* @__PURE__ */ o((e, t) => {
...
var eo = p((Qf, H) => {
  ...
  { mergePromise: Jn, getSpawnedPromise: Fa } = Wn(), { joinCommand: Xn, parseCommand: Yn, getEscapedCommand: Qn } = zn(), Ua = 1e3 * 1e3 * 100,
  ...
  Ca(t) : t, "handleOutput"), Pe = /* @__PURE__ */ o((e, t, r) => {
    let n = Zn(e, t, r), i = Xn(e, t), s = Qn(e, t);
    ja(n.options);
    let a;
    try {
    ...
    let b = Aa(/* @__PURE__ */ o(async () => {
      let [{ error: m, exitCode: g, signal: h, timedOut: S }, T, E, I] = await Da(a, n.options, l), O = Q(n.options, T), A = Q(n.options, E),
      d = Q(n.options, I);
      if (m || g !== 0 || h !== null) {
        let v = ve({
          error: m,
...
function ac(e = {}) {
  ...
  } = e, i, s = t instanceof URL ? sc.fileURLToPath(t) : t, a = Z.resolve(s), c = [];
  for (; i !== a; )
...
decode(e, { stream: !0 }), "useTextDecoder"), Qc = /* @__PURE__ */ o((e, { contents: t }) => t + e, "addStringChunk"), Zc = /* @__PURE__ */ o(
...
import { createHash as Zo, randomBytes as Tu } from "node:crypto";
...
var Yt = class {
  ...
  constructor(t = {}) {
    ...
    "base64").replace(/\//g, "-")), this.ttl = t.ttl || 0, Zo(this.hash_alg), Xt(this.cache_dir, { recursive: !0 });
  }
  generateHash(t) {
    return ne(this.cache_dir, this.prefix + Zo(this.hash_alg).update(t).digest("hex"));
  }
  isExpired(t, r) {
...
import si, { promises as Um } from "node:fs";
...
import zm, { promises as Jm } from "node:fs";
...
var rr = /* @__PURE__ */ o(async (e) => {
  ...
  let t = y.resolve(Qu(e, "package.json"), {
    paths: [process.cwd()]
  });
...
var nl = /* @__PURE__ */ o((e) => {
  let t = Zu(e).replace(new RegExp(/\\/, "g"), "/");
...
// src/telemetry/index.ts
var Mg = /* @__PURE__ */ o((e) => e.startsWith("example-button--") || e.startsWith("example-header--") || e.startsWith("example-page--"), "i\
sExampleStoryId"), Lg = /* @__PURE__ */ o(async (e, t = {}, r = {}) => {
